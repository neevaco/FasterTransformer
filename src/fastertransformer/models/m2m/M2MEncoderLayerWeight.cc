...
template<typename T>
M2MEncoderLayerWeight<T>::M2MEncoderLayerWeight(const size_t head_num,
...
template<typename T>
void M2MEncoderLayerWeight<T>::initialize()
{
    FT_LOG_DEBUG("M2MEncoderLayerWeight " + std::string(__func__) + " start");
...
template<typename T>
M2MEncoderLayerWeight<T>::~M2MEncoderLayerWeight()
{
    FT_LOG_DEBUG("M2MEncoderLayerWeight " + std::string(__func__) + " start");
...
template<typename T>
M2MEncoderLayerWeight<T>::M2MEncoderLayerWeight(const M2MEncoderLayerWeight& other):
...
template<typename T>
M2MEncoderLayerWeight<T>& M2MEncoderLayerWeight<T>::operator=(const M2MEncoderLayerWeight<T>& other)
{
    FT_LOG_DEBUG("M2MEncoderLayerWeight " + std::string(__func__) + " start");
...
template<typename T>
void M2MEncoderLayerWeight<T>::compress_weights(cublasMMWrapper& cublas_wrapper, int hidden_dim)
{
    FT_LOG_DEBUG("M2MEncoderLayerWeight " + std::string(__func__) + " start");
...
template<typename T>
void M2MEncoderLayerWeight<T>::setWeightPtr()
{
    FT_LOG_DEBUG("M2MEncoderLayerWeight " + std::string(__func__) + " start");
...
template<typename T>
void M2MEncoderLayerWeight<T>::mallocWeights()
{
    FT_LOG_DEBUG("M2MEncoderLayerWeight " + std::string(__func__) + " start");
    for (int i = 0; i < real_weights_num_; i++) {
...
template<typename T>
void M2MEncoderLayerWeight<T>::loadModel(std::string dir_path, FtCudaDataType model_file_type)
{
    FT_LOG_DEBUG("M2MEncoderLayerWeight " + std::string(__func__) + " start");
...
template struct M2MEncoderLayerWeight<half>;
#ifdef ENABLE_BF16
template struct M2MEncoderLayerWeight<__nv_bfloat16>;
#endif
