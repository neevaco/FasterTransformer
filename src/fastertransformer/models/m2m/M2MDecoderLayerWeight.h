...
template<typename T>
struct M2MDecoderLayerWeight {

    M2MDecoderLayerWeight() = default;
    M2MDecoderLayerWeight(const size_t head_num,
    ...
    M2MDecoderLayerWeight& operator=(const M2MDecoderLayerWeight& other);
