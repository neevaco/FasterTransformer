...
#define MGQA_LAUNCH_KERNEL(                                                                                            \
    ...
    cudaFuncSetAttribute(mmha::masked_multihead_attention_kernel<T, Dh, Dh_MAX,  THDS_PER_KEY, THDS_PER_VALUE,  THDS_PER_BLOCK,  HAS_BEAMS>, cudaFuncAttributeMaxDynamicSharedMemorySize, smem_sz);           \
