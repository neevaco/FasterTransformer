...
inline __device__ float2 rotary_embedding_coefficient(const int zid, const int rot_embed_dim, const float t_step, const float rope_theta=1000.f)
{
    const float inv_freq = t_step / pow(1000000.0f, zid / (float)rot_embed_dim);
